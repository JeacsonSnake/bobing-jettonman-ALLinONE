    const gameRule = {
        ...
        "SiJin": new RegExp("^[1]{5}|[2][5]|[3]{5}|[5]{5}|[6]{5}$"), // 四进(进士)
        'ErJu': new RegExp("^([1-3]{0,4}44){1}[5-6]{0,4}$"), // 二举(举人)
        'YiXiu': new RegExp("^([1-3]{0,5}4){1}[5-6]{0,5}$"), // 一秀(秀才)
        "NULL": new RegExp("") // 博空
    }
    const zhuangyuan = ["ZhuangYuanChaJinHua", "LiuBoHong", "BianDiJing", "LiuBoHei", "WuBoHong", "WuBoHei", "SiDianHong"]
    ...
    function getRandomResult() {
        ...
        let orderdRandomString = Array.from(randomString).map(Number).sort((a, b) => {return a - b}).join('')
